...
export class StringKeyValue extends jspb.Message {
  getKey(): string;
  setKey(value: string): void;
  ...
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): StringKeyValue.AsObject;
  static toObject(includeInstance: boolean, msg: StringKeyValue): StringKeyValue.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: StringKeyValue, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): StringKeyValue;
  static deserializeBinaryFromReader(message: StringKeyValue, reader: jspb.BinaryReader): StringKeyValue;
}

export namespace StringKeyValue {
  export type AsObject = {
    key: string,
    value: string,
  }
