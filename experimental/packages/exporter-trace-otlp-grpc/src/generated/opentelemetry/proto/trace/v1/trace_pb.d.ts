...
export class Status extends jspb.Message {
  getDeprecatedCode(): Status.DeprecatedStatusCodeMap[keyof Status.DeprecatedStatusCodeMap];
  setDeprecatedCode(value: Status.DeprecatedStatusCodeMap[keyof Status.DeprecatedStatusCodeMap]): void;
...
export namespace Status {
  export type AsObject = {
    deprecatedCode: Status.DeprecatedStatusCodeMap[keyof Status.DeprecatedStatusCodeMap],
    message: string,
    code: Status.StatusCodeMap[keyof Status.StatusCodeMap],
  }

  export interface DeprecatedStatusCodeMap {
  ...
  export const DeprecatedStatusCode: DeprecatedStatusCodeMap;
